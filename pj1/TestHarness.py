...
def tests_to_run(forwarder):
    ...
    BasicTest.BasicTest(forwarder, "test-picture.jpg")
    RandomDropTest.RandomDropTest(forwarder, "test-picture.jpg")
    RandomCorruptTest.RandomCorruptTest(forwarder, "test-picture.jpg")   #need to fix
    RandomReorderTest.RandomReorderTest(forwarder, "test-picture.jpg")
    #RandomDelayTest.RandomDelayTest(forwarder, "test-picture.jpg")
    RandomDuplicateTest.RandomDuplicateTest(forwarder, "test-picture.jpg") #retest later
